...
export default class Map extends Component {
    ...
    componentDidMount() {
        this.extendChinaProvider();
        const zoom = {
            maxZoom: 18,
            minZoom: 4
        };

        let normalm = L.tileLayer.chinaProvider('GaoDe.Normal.Map', zoom);
        let imgm = L.tileLayer.chinaProvider('GaoDe.Satellite.Map', zoom);
        let imga = L.tileLayer.chinaProvider('GaoDe.Satellite.Annotion', zoom);
